...
export const experiments = [
  { id: 'EXP–001', title: 'Spring response', path: '/lab/spring/', medium: 'JavaScript / SVG', status: 'Interactive study', description: 'An adjustable spring response. Change the damping, watch the overshoot, and compare the result.' },
