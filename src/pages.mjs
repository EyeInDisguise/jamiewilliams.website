...
import { abilitySelector } from './ability-selector.mjs';
export const pages = [{
  path: '/', title: 'Home', description: 'Jamie Williams’s personal website. Computer science, game development, and projects.', script: '/assets/ability-selector.js',
